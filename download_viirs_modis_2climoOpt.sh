...
usage="Usage: ./download_modis.sh [-s start date (YYYY-MM-DD)] [-e end date (YYYY-MM-DD)] [-n product short name e.g. MCD43A3] [-t tile e.g. h12v04] [-d download dir] [-m file location]"
...
#cur_date=${start_date}
#last_date=$(date -I -d "$end_date day")
